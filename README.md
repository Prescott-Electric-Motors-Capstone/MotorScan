<h1>Prescott Electric Motors Project</h1>
...
Once the project has been downloaded, run ```npm install``` to install the node_modules and the necessary packages. Then do ```npm install``` to start the project (Metro bundle), and the QR code can be scanned with your devices to display the app.
